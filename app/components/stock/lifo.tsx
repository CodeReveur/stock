...
const LifoStock = () => {
    ...
    useEffect(()=> {
      const fetchStock = async () => {
        try {
          const response = await fetch(`/api/stock/batch_stock?batch=LIFO&startDate=${startDate}&category=${category}&endDate=${endDate}&supplier=${supplier}`);
  ...
  return (
    <div className="p-5 bg-neutral-900 rounded-lg h-max">
      ...
      <div className="pb-4 flex justify-between items-center">
        <h4 className="text-violet-800 ">LIFO stock</h4>
        <div>
        <div  
